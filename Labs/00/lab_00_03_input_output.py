...
# comment this code.
# Then change it so that the four print statements are combined into a single print statement that does the same thing.

first = input("What is the name of your favorite musician or band?")
